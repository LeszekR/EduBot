...
-- Started on 2017-10-08 20:53:05
...
--
-- TOC entry 2216 (class 1262 OID 83167)
...
--
-- TOC entry 195 (class 1259 OID 83959)
...
--
-- TOC entry 194 (class 1259 OID 83957)
...
--
-- TOC entry 192 (class 1259 OID 83925)
...
--
-- TOC entry 193 (class 1259 OID 83944)
...
--
-- TOC entry 191 (class 1259 OID 83923)
...
--
-- TOC entry 186 (class 1259 OID 83881)
...
--
-- TOC entry 187 (class 1259 OID 83889)
...
--
-- TOC entry 188 (class 1259 OID 83897)
...
--
-- TOC entry 185 (class 1259 OID 83779)
-- Name: enum_user_type; Type: TABLE; Schema: public; Owner: lmp
--
...
ALTER TABLE enum_user_type OWNER TO lmp;

--
-- TOC entry 190 (class 1259 OID 83907)
...
CREATE TABLE "user" (
    ...
    role character varying DEFAULT 'pupil'::character varying NOT NULL,
...
--
-- TOC entry 197 (class 1259 OID 83983)
...
--
-- TOC entry 196 (class 1259 OID 83968)
...
--
-- TOC entry 189 (class 1259 OID 83905)
...
--
-- TOC entry 2053 (class 2604 OID 83962)
...
--
-- TOC entry 2052 (class 2604 OID 83928)
...
--
-- TOC entry 2049 (class 2604 OID 83910)
...
--
-- TOC entry 2209 (class 0 OID 83959)
-- Dependencies: 195
...
--
-- TOC entry 2206 (class 0 OID 83925)
-- Dependencies: 192
...
--
-- TOC entry 2207 (class 0 OID 83944)
-- Dependencies: 193
...
--
-- TOC entry 2200 (class 0 OID 83881)
-- Dependencies: 186
...
--
-- TOC entry 2201 (class 0 OID 83889)
-- Dependencies: 187
...
--
-- TOC entry 2202 (class 0 OID 83897)
-- Dependencies: 188
...
--
-- TOC entry 2199 (class 0 OID 83779)
-- Dependencies: 185
-- Data for Name: enum_user_type; Type: TABLE DATA; Schema: public; Owner: lmp
--

COPY enum_user_type (role) FROM stdin;
\.


--
-- TOC entry 2204 (class 0 OID 83907)
-- Dependencies: 190
-- Data for Name: user; Type: TABLE DATA; Schema: public; Owner: lmp
--

COPY "user" (id, login, password, role, score) FROM stdin;
1	pysio	grubasek	pupil	0
\.


--
-- TOC entry 2211 (class 0 OID 83983)
-- Dependencies: 197
...
--
-- TOC entry 2210 (class 0 OID 83968)
-- Dependencies: 196
...
--
-- TOC entry 2069 (class 2606 OID 83967)
...
--
-- TOC entry 2067 (class 2606 OID 83951)
...
--
-- TOC entry 2065 (class 2606 OID 83933)
...
--
-- TOC entry 2057 (class 2606 OID 83888)
...
--
-- TOC entry 2059 (class 2606 OID 83896)
...
--
-- TOC entry 2061 (class 2606 OID 83904)
...
--
-- TOC entry 2055 (class 2606 OID 83786)
-- Name: enum_user_type enum_user_type_pkey; Type: CONSTRAINT; Schema: public; Owner: lmp
--

ALTER TABLE ONLY enum_user_type
    ADD CONSTRAINT enum_user_type_pkey PRIMARY KEY (role);


--
-- TOC entry 2073 (class 2606 OID 83987)
...
--
-- TOC entry 2071 (class 2606 OID 83972)
...
--
-- TOC entry 2063 (class 2606 OID 83917)
...
--
-- TOC entry 2075 (class 2606 OID 83934)
...
--
-- TOC entry 2077 (class 2606 OID 83952)
...
--
-- TOC entry 2076 (class 2606 OID 83939)
...
--
-- TOC entry 2081 (class 2606 OID 83993)
...
--
-- TOC entry 2080 (class 2606 OID 83988)
...
--
-- TOC entry 2079 (class 2606 OID 83978)
...
--
-- TOC entry 2078 (class 2606 OID 83973)
...
--
-- TOC entry 2074 (class 2606 OID 83918)
...
-- Completed on 2017-10-08 20:53:07
