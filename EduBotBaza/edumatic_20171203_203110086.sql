...
-- Started on 2017-12-03 20:31:10
...
29	35	medium	Mrówka	Wodorost skłebiony, faluje płynnie w toni błękitu łuską rybią śluzionego.\n\nKurczaki górą. Dwie piędzie dębiny i baran.\n\nTekst próbny. Ale to nie znaczy że mniej wazny!\nNo a poza tym to kto by się spodziewał hiszpańskiej inkwizycji w polu tekstowym pracy dyplomowej. Hm. Nikt?\n\nA tu - niespodzianka!\nBo tu bedzie WIEDZA przez duże DZ.\nAle jeszcze nie teraz.\nPóżniej.	Kurka, kurka, gęś.\nKaczorek.\nTraszka pospolita w koninkcji z wielbładzim przyrybkiem chropatym.\n\n\nStuka, puka , kręci, wierci. A to tylko programista na wiosnę.\n\nNo i, oczywiście, przykład z kodu:\nfor (var nic in cośtamcośtam)\n    wykonaj_czynności();\n    zawiadom_mame_ze_zrobione();\nreturn kasa_na_lody;\n\nProszę pana, ale jak tu ja, student, umieścić mam coś. Przecież nie umiem.\nTo niemożliwe jest wymagać od nieumiejącego.\nDlatego wnioskuję o nie wymaganie i miłościwość.\nBo jak nie to pójdę się poskarżyć i będzie ŹLE.	\N		\N
33	20	easy	Karoca złota, osie platynowe	Rękawiczki ze skóry krokodylej. Stadardowe wyposażenie programisty .NET.	Bez przykładu. Niech se uczeń sam wymyśli.	\N		\N
34	29	easy	Wczasy w górach	Moduł łatwy, dla chętnych, rączek nie urywa.	Przykład ciężki. Potwornie męczący. Mąci w zwojach. Klawiaturę grzeje po stronie wschodniej.	\N		\N
...
44	\N	hard	Lista numerków małych	Przykład\nRozkład\nNakład\nPodkład\nWykład\nWkład\nZakład\n\n\nTekst na niedzielę, szybki, krótki, dogłębny i pouczający.\n\nW lewo\n\nPod górkę i schodami w dół	if (nic) then\n    coś;\n    potem jeszcze;\nendif\n\nZnów bez przykładu.\nA może by jednak?\nOk, niech będzie.\n\n"Przykład"\n\nOk?\n\npotem w prawo\n\n18 baryłek rumu\n3 kopy jaj\n9 beczek dziegciu zagęszczanego piwem\n13 noży do sztaksli\n5 haków z zacięciem	\N		\N
37	43	easy	Numer 1	W lewo	potem w prawo	\N		\N
38	43	easy	Numer 2	Pod górkę i schodami w dół	18 baryłek rumu\n3 kopy jaj\n9 beczek dziegciu zagęszczanego piwem\n13 noży do sztaksli\n5 haków z zacięciem	\N		\N
39	41	easy	Morze, żywioł chłodny	Przykład\nRozkład\nNakład\nPodkład\nWykład\nWkład\nZakład\n	if (nic) then\n    coś;\n    potem jeszcze;\nendif	\N		\N
40	41	easy	Góry, żywioł dziki	Tekst na niedzielę, szybki, krótki, dogłębny i pouczający.	Znów bez przykładu.\nA może by jednak?\nOk, niech będzie.\n\n"Przykład"\n\nOk?	\N		\N
42	\N	easy	Numerek 15		\N	\N		\N
41	44	medium	Życie w żywiołach	Przykład\nRozkład\nNakład\nPodkład\nWykład\nWkład\nZakład\n\n\nTekst na niedzielę, szybki, krótki, dogłębny i pouczający.	if (nic) then\n    coś;\n    potem jeszcze;\nendif\n\nZnów bez przykładu.\nA może by jednak?\nOk, niech będzie.\n\n"Przykład"\n\nOk?	\N		\N
...
SELECT pg_catalog.setval('edumodule_id_seq', 45, true);
...
-- Completed on 2017-12-03 20:31:11
