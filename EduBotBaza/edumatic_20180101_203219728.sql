...
-- Started on 2018-01-01 20:32:20
...
--
-- TOC entry 2260 (class 1262 OID 83167)
...
--
-- TOC entry 2246 (class 0 OID 83959)
-- Dependencies: 193
...
--
-- TOC entry 2243 (class 0 OID 83925)
-- Dependencies: 190
...
--
-- TOC entry 2244 (class 0 OID 83944)
-- Dependencies: 191
...
--
-- TOC entry 2238 (class 0 OID 83881)
-- Dependencies: 185
...
--
-- TOC entry 2255 (class 0 OID 102772)
-- Dependencies: 202
...
--
-- TOC entry 2239 (class 0 OID 83897)
-- Dependencies: 186
...
--
-- TOC entry 2252 (class 0 OID 94585)
-- Dependencies: 199
...
1	0	38	Napisz program, który włamuje się do serwerwa PG i zalicza dyplom wskazanego studenta.^{'ocena': '5', 'oferty_pracy': '84', 'proponowane_wynagrodzenie': '150.000'}^"<!DOCTYPE html>\n            <html>\n                <head>\n                    <title>TODO supply a title</title>\n                    <meta charset="UTF-8">\n                    <meta name="viewport" content="width=device-width, initial-scale=1.0">\n                    <script src="saper.js"></script>\n            \n                    <link rel="stylesheet" type="text/css" href="saper.css">\n            \n                </head>\n                <body onload="init()">\n                    <div>\n                        <div id="menu">\n                            <div id="opisy">\n            "
2	1	38	Zaprogramuj wyrzynarkę do marchwi w JavaScript^8 średnich marchwi na minutę | 5 dużych^"    <body onload="init()">\n            <div>\n                <div id="menu">\n                    <div id="opisy">\n                        <div>\n                            <label class="opisPola" for="txRyzyko">Poziom ryzyka</label>\n                        </div>\n                        <div>\n                            <label class="opisPola" for="boardSize">Rozmiar planszy</label>\n                        </div>\n                    </div>\n                    <div id="polaText">\n                        <div>\n                            <input type="text" id="txRyzyko" autofocus>\n                        </div>\n                        <div>\n                            <input type="text" id="boardSize" onchange="generateNewBoard()">\n                        </div>\n                    </div>\n                </div>\n    \n                <div id="gra">\n                    <div><input type="button" value="Generuj planszę" accesskey="g" onclick="generateNewBoard()"></div>\n                    <div id="lewy" style="float:left"></div>\n                    <div id="board"  style="float:left"></div>\n                    <div id="prawy"  style="float:left"></div>\n                </div>\n    \n            </div>\n    "
3	2	38	Napisz przeszukiwanie w głąb planu zajęć PG oparte na kopcu Fibonacciego, nie stosując znaku '=', wykorzystując drzewo binarne czarno-czerowno-seledynowe, zoptymalizowane dla branek OR, XOR i XEROX oraz zwracające wynik w postaci XML w base64 w UTF-51, z ponięciem znaków o indeksach liczb pierwszych.^Łatwizna. Ale dajcie dziennym, połowa popełni samobójstwo zanim skończy czytać polecenie.^Po co. Rzut oka na wynik i będzie przecież widać czy jest ok.
4	3	38	Wykorzystując przekazywanie zmiennej przez referencję oraz wielokrotne dziedziczenie diamentowe oblicz sumę.^5^Nie ma sensu bo każdy procesor się na tym spali. Niech się student męczy, przecież tego się nie da, hi, hi...
5	0	37	Napisz program, który włamuje się do serwerwa PG i zalicza dyplom wskazanego studenta.^{'ocena': '5', 'oferty_pracy': '84', 'proponowane_wynagrodzenie': '150.000'}^"<!DOCTYPE html>\n            <html>\n                <head>\n                    <title>TODO supply a title</title>\n                    <meta charset="UTF-8">\n                    <meta name="viewport" content="width=device-width, initial-scale=1.0">\n                    <script src="saper.js"></script>\n            \n                    <link rel="stylesheet" type="text/css" href="saper.css">\n            \n                </head>\n                <body onload="init()">\n                    <div>\n                        <div id="menu">\n                            <div id="opisy">\n            "
6	1	37	Zaprogramuj wyrzynarkę do marchwi w JavaScript^8 średnich marchwi na minutę | 5 dużych^"    <body onload="init()">\n            <div>\n                <div id="menu">\n                    <div id="opisy">\n                        <div>\n                            <label class="opisPola" for="txRyzyko">Poziom ryzyka</label>\n                        </div>\n                        <div>\n                            <label class="opisPola" for="boardSize">Rozmiar planszy</label>\n                        </div>\n                    </div>\n                    <div id="polaText">\n                        <div>\n                            <input type="text" id="txRyzyko" autofocus>\n                        </div>\n                        <div>\n                            <input type="text" id="boardSize" onchange="generateNewBoard()">\n                        </div>\n                    </div>\n                </div>\n    \n                <div id="gra">\n                    <div><input type="button" value="Generuj planszę" accesskey="g" onclick="generateNewBoard()"></div>\n                    <div id="lewy" style="float:left"></div>\n                    <div id="board"  style="float:left"></div>\n                    <div id="prawy"  style="float:left"></div>\n                </div>\n    \n            </div>\n    "
7	2	37	Napisz przeszukiwanie w głąb planu zajęć PG oparte na kopcu Fibonacciego, nie stosując znaku '=', wykorzystując drzewo binarne czarno-czerowno-seledynowe, zoptymalizowane dla branek OR, XOR i XEROX oraz zwracające wynik w postaci XML w base64 w UTF-51, z ponięciem znaków o indeksach liczb pierwszych.^Łatwizna. Ale dajcie dziennym, połowa popełni samobójstwo zanim skończy czytać polecenie.^Po co. Rzut oka na wynik i będzie przecież widać czy jest ok.
8	3	37	Wykorzystując przekazywanie zmiennej przez referencję oraz wielokrotne dziedziczenie diamentowe oblicz sumę.^5^Nie ma sensu bo każdy procesor się na tym spali. Niech się student męczy, przecież tego się nie da, hi, hi...
9	0	11	Napisz program, który włamuje się do serwerwa PG i zalicza dyplom wskazanego studenta.^{'ocena': '5', 'oferty_pracy': '84', 'proponowane_wynagrodzenie': '150.000'}^"<!DOCTYPE html>\n            <html>\n                <head>\n                    <title>TODO supply a title</title>\n                    <meta charset="UTF-8">\n                    <meta name="viewport" content="width=device-width, initial-scale=1.0">\n                    <script src="saper.js"></script>\n            \n                    <link rel="stylesheet" type="text/css" href="saper.css">\n            \n                </head>\n                <body onload="init()">\n                    <div>\n                        <div id="menu">\n                            <div id="opisy">\n            "
10	1	11	Zaprogramuj wyrzynarkę do marchwi w JavaScript^8 średnich marchwi na minutę | 5 dużych^"    <body onload="init()">\n            <div>\n                <div id="menu">\n                    <div id="opisy">\n                        <div>\n                            <label class="opisPola" for="txRyzyko">Poziom ryzyka</label>\n                        </div>\n                        <div>\n                            <label class="opisPola" for="boardSize">Rozmiar planszy</label>\n                        </div>\n                    </div>\n                    <div id="polaText">\n                        <div>\n                            <input type="text" id="txRyzyko" autofocus>\n                        </div>\n                        <div>\n                            <input type="text" id="boardSize" onchange="generateNewBoard()">\n                        </div>\n                    </div>\n                </div>\n    \n                <div id="gra">\n                    <div><input type="button" value="Generuj planszę" accesskey="g" onclick="generateNewBoard()"></div>\n                    <div id="lewy" style="float:left"></div>\n                    <div id="board"  style="float:left"></div>\n                    <div id="prawy"  style="float:left"></div>\n                </div>\n    \n            </div>\n    "
11	2	11	Napisz przeszukiwanie w głąb planu zajęć PG oparte na kopcu Fibonacciego, nie stosując znaku '=', wykorzystując drzewo binarne czarno-czerowno-seledynowe, zoptymalizowane dla branek OR, XOR i XEROX oraz zwracające wynik w postaci XML w base64 w UTF-51, z ponięciem znaków o indeksach liczb pierwszych.^Łatwizna. Ale dajcie dziennym, połowa popełni samobójstwo zanim skończy czytać polecenie.^Po co. Rzut oka na wynik i będzie przecież widać czy jest ok.
12	3	11	Wykorzystując przekazywanie zmiennej przez referencję oraz wielokrotne dziedziczenie diamentowe oblicz sumę.^5^Nie ma sensu bo każdy procesor się na tym spali. Niech się student męczy, przecież tego się nie da, hi, hi...
13	0	34	Napisz program, który włamuje się do serwerwa PG i zalicza dyplom wskazanego studenta.^{'ocena': '5', 'oferty_pracy': '84', 'proponowane_wynagrodzenie': '150.000'}^"<!DOCTYPE html>\n            <html>\n                <head>\n                    <title>TODO supply a title</title>\n                    <meta charset="UTF-8">\n                    <meta name="viewport" content="width=device-width, initial-scale=1.0">\n                    <script src="saper.js"></script>\n            \n                    <link rel="stylesheet" type="text/css" href="saper.css">\n            \n                </head>\n                <body onload="init()">\n                    <div>\n                        <div id="menu">\n                            <div id="opisy">\n            "
14	1	34	Zaprogramuj wyrzynarkę do marchwi w JavaScript^8 średnich marchwi na minutę | 5 dużych^"    <body onload="init()">\n            <div>\n                <div id="menu">\n                    <div id="opisy">\n                        <div>\n                            <label class="opisPola" for="txRyzyko">Poziom ryzyka</label>\n                        </div>\n                        <div>\n                            <label class="opisPola" for="boardSize">Rozmiar planszy</label>\n                        </div>\n                    </div>\n                    <div id="polaText">\n                        <div>\n                            <input type="text" id="txRyzyko" autofocus>\n                        </div>\n                        <div>\n                            <input type="text" id="boardSize" onchange="generateNewBoard()">\n                        </div>\n                    </div>\n                </div>\n    \n                <div id="gra">\n                    <div><input type="button" value="Generuj planszę" accesskey="g" onclick="generateNewBoard()"></div>\n                    <div id="lewy" style="float:left"></div>\n                    <div id="board"  style="float:left"></div>\n                    <div id="prawy"  style="float:left"></div>\n                </div>\n    \n            </div>\n    "
15	2	34	Napisz przeszukiwanie w głąb planu zajęć PG oparte na kopcu Fibonacciego, nie stosując znaku '=', wykorzystując drzewo binarne czarno-czerowno-seledynowe, zoptymalizowane dla branek OR, XOR i XEROX oraz zwracające wynik w postaci XML w base64 w UTF-51, z ponięciem znaków o indeksach liczb pierwszych.^Łatwizna. Ale dajcie dziennym, połowa popełni samobójstwo zanim skończy czytać polecenie.^Po co. Rzut oka na wynik i będzie przecież widać czy jest ok.
16	3	34	Wykorzystując przekazywanie zmiennej przez referencję oraz wielokrotne dziedziczenie diamentowe oblicz sumę.^5^Nie ma sensu bo każdy procesor się na tym spali. Niech się student męczy, przecież tego się nie da, hi, hi...
17	0	8	Napisz program, który włamuje się do serwerwa PG i zalicza dyplom wskazanego studenta.^{'ocena': '5', 'oferty_pracy': '84', 'proponowane_wynagrodzenie': '150.000'}^"<!DOCTYPE html>\n            <html>\n                <head>\n                    <title>TODO supply a title</title>\n                    <meta charset="UTF-8">\n                    <meta name="viewport" content="width=device-width, initial-scale=1.0">\n                    <script src="saper.js"></script>\n            \n                    <link rel="stylesheet" type="text/css" href="saper.css">\n            \n                </head>\n                <body onload="init()">\n                    <div>\n                        <div id="menu">\n                            <div id="opisy">\n            "
18	1	8	Zaprogramuj wyrzynarkę do marchwi w JavaScript^8 średnich marchwi na minutę | 5 dużych^"    <body onload="init()">\n            <div>\n                <div id="menu">\n                    <div id="opisy">\n                        <div>\n                            <label class="opisPola" for="txRyzyko">Poziom ryzyka</label>\n                        </div>\n                        <div>\n                            <label class="opisPola" for="boardSize">Rozmiar planszy</label>\n                        </div>\n                    </div>\n                    <div id="polaText">\n                        <div>\n                            <input type="text" id="txRyzyko" autofocus>\n                        </div>\n                        <div>\n                            <input type="text" id="boardSize" onchange="generateNewBoard()">\n                        </div>\n                    </div>\n                </div>\n    \n                <div id="gra">\n                    <div><input type="button" value="Generuj planszę" accesskey="g" onclick="generateNewBoard()"></div>\n                    <div id="lewy" style="float:left"></div>\n                    <div id="board"  style="float:left"></div>\n                    <div id="prawy"  style="float:left"></div>\n                </div>\n    \n            </div>\n    "
19	2	8	Napisz przeszukiwanie w głąb planu zajęć PG oparte na kopcu Fibonacciego, nie stosując znaku '=', wykorzystując drzewo binarne czarno-czerowno-seledynowe, zoptymalizowane dla branek OR, XOR i XEROX oraz zwracające wynik w postaci XML w base64 w UTF-51, z ponięciem znaków o indeksach liczb pierwszych.^Łatwizna. Ale dajcie dziennym, połowa popełni samobójstwo zanim skończy czytać polecenie.^Po co. Rzut oka na wynik i będzie przecież widać czy jest ok.
20	3	8	Wykorzystując przekazywanie zmiennej przez referencję oraz wielokrotne dziedziczenie diamentowe oblicz sumę.^5^Nie ma sensu bo każdy procesor się na tym spali. Niech się student męczy, przecież tego się nie da, hi, hi...
21	0	10	Napisz program, który włamuje się do serwerwa PG i zalicza dyplom wskazanego studenta.^{'ocena': '5', 'oferty_pracy': '84', 'proponowane_wynagrodzenie': '150.000'}^"<!DOCTYPE html>\n            <html>\n                <head>\n                    <title>TODO supply a title</title>\n                    <meta charset="UTF-8">\n                    <meta name="viewport" content="width=device-width, initial-scale=1.0">\n                    <script src="saper.js"></script>\n            \n                    <link rel="stylesheet" type="text/css" href="saper.css">\n            \n                </head>\n                <body onload="init()">\n                    <div>\n                        <div id="menu">\n                            <div id="opisy">\n            "
22	1	10	Zaprogramuj wyrzynarkę do marchwi w JavaScript^8 średnich marchwi na minutę | 5 dużych^"    <body onload="init()">\n            <div>\n                <div id="menu">\n                    <div id="opisy">\n                        <div>\n                            <label class="opisPola" for="txRyzyko">Poziom ryzyka</label>\n                        </div>\n                        <div>\n                            <label class="opisPola" for="boardSize">Rozmiar planszy</label>\n                        </div>\n                    </div>\n                    <div id="polaText">\n                        <div>\n                            <input type="text" id="txRyzyko" autofocus>\n                        </div>\n                        <div>\n                            <input type="text" id="boardSize" onchange="generateNewBoard()">\n                        </div>\n                    </div>\n                </div>\n    \n                <div id="gra">\n                    <div><input type="button" value="Generuj planszę" accesskey="g" onclick="generateNewBoard()"></div>\n                    <div id="lewy" style="float:left"></div>\n                    <div id="board"  style="float:left"></div>\n                    <div id="prawy"  style="float:left"></div>\n                </div>\n    \n            </div>\n    "
23	2	10	Napisz przeszukiwanie w głąb planu zajęć PG oparte na kopcu Fibonacciego, nie stosując znaku '=', wykorzystując drzewo binarne czarno-czerowno-seledynowe, zoptymalizowane dla branek OR, XOR i XEROX oraz zwracające wynik w postaci XML w base64 w UTF-51, z ponięciem znaków o indeksach liczb pierwszych.^Łatwizna. Ale dajcie dziennym, połowa popełni samobójstwo zanim skończy czytać polecenie.^Po co. Rzut oka na wynik i będzie przecież widać czy jest ok.
24	3	10	Wykorzystując przekazywanie zmiennej przez referencję oraz wielokrotne dziedziczenie diamentowe oblicz sumę.^5^Nie ma sensu bo każdy procesor się na tym spali. Niech się student męczy, przecież tego się nie da, hi, hi...
25	0	39	Napisz program, który włamuje się do serwerwa PG i zalicza dyplom wskazanego studenta.^{'ocena': '5', 'oferty_pracy': '84', 'proponowane_wynagrodzenie': '150.000'}^"<!DOCTYPE html>\n            <html>\n                <head>\n                    <title>TODO supply a title</title>\n                    <meta charset="UTF-8">\n                    <meta name="viewport" content="width=device-width, initial-scale=1.0">\n                    <script src="saper.js"></script>\n            \n                    <link rel="stylesheet" type="text/css" href="saper.css">\n            \n                </head>\n                <body onload="init()">\n                    <div>\n                        <div id="menu">\n                            <div id="opisy">\n            "
26	1	39	Zaprogramuj wyrzynarkę do marchwi w JavaScript^8 średnich marchwi na minutę | 5 dużych^"    <body onload="init()">\n            <div>\n                <div id="menu">\n                    <div id="opisy">\n                        <div>\n                            <label class="opisPola" for="txRyzyko">Poziom ryzyka</label>\n                        </div>\n                        <div>\n                            <label class="opisPola" for="boardSize">Rozmiar planszy</label>\n                        </div>\n                    </div>\n                    <div id="polaText">\n                        <div>\n                            <input type="text" id="txRyzyko" autofocus>\n                        </div>\n                        <div>\n                            <input type="text" id="boardSize" onchange="generateNewBoard()">\n                        </div>\n                    </div>\n                </div>\n    \n                <div id="gra">\n                    <div><input type="button" value="Generuj planszę" accesskey="g" onclick="generateNewBoard()"></div>\n                    <div id="lewy" style="float:left"></div>\n                    <div id="board"  style="float:left"></div>\n                    <div id="prawy"  style="float:left"></div>\n                </div>\n    \n            </div>\n    "
27	2	39	Napisz przeszukiwanie w głąb planu zajęć PG oparte na kopcu Fibonacciego, nie stosując znaku '=', wykorzystując drzewo binarne czarno-czerowno-seledynowe, zoptymalizowane dla branek OR, XOR i XEROX oraz zwracające wynik w postaci XML w base64 w UTF-51, z ponięciem znaków o indeksach liczb pierwszych.^Łatwizna. Ale dajcie dziennym, połowa popełni samobójstwo zanim skończy czytać polecenie.^Po co. Rzut oka na wynik i będzie przecież widać czy jest ok.
28	3	39	Wykorzystując przekazywanie zmiennej przez referencję oraz wielokrotne dziedziczenie diamentowe oblicz sumę.^5^Nie ma sensu bo każdy procesor się na tym spali. Niech się student męczy, przecież tego się nie da, hi, hi...
\.
...
SELECT pg_catalog.setval('test_code_id_seq', 28, true);


--
-- TOC entry 2250 (class 0 OID 94568)
-- Dependencies: 197
...
16	3	8	Wór kostek małych to w podstawowej wersji jest:^2^żywnośc dla kota*żywność dla marynarzy na morzu*chrzęszcząca trzęsawka akustyczna*masażer de luxe bez intsrukcji
...
32	3	48	Wór kostek małych to w podstawowej wersji jest:^2^żywnośc dla kota*żywność dla marynarzy na morzu*chrzęszcząca trzęsawka akustyczna*masażer de luxe bez intsrukcji
...
24	3	11	Wór kostek małych to w podstawowej wersji jest:^0^żywnośc dla kota*żywność dla marynarzy na morzu*chrzęszcząca trzęsawka akustyczna*masażer de luxe bez intsrukcji
28	3	48	Wór kostek małych to w podstawowej wersji jest:^2^żywnośc dla kota*żywność dla marynarzy na morzu*chrzęszcząca trzęsawka akustyczna*masażer de luxe bez intsrukcji
18	2	37	Grube bale leżą na łące. Kto je poprzynosił, dlaczego i jak zostaną później pocieniowane?^1^Bysio z Dużej, nie zostaną w ogóle.*Ludzie z bagna to przyniesli! to nie my.*Stefan. To zawsze on, przecie waidomo.
20	3	37	Wór kostek małych to w podstawowej wersji jest:^3^żywnośc dla kota*żywność dla marynarzy na morzu*chrzęszcząca trzęsawka akustyczna*masażer de luxe bez intsrukcji
\.
...
--
-- TOC entry 2241 (class 0 OID 83907)
-- Dependencies: 188
...
--
-- TOC entry 2254 (class 0 OID 94616)
-- Dependencies: 201
...
--
-- TOC entry 2248 (class 0 OID 83983)
-- Dependencies: 195
...
1	1	2018-01-01 15:17:26.613791
\.


--
-- TOC entry 2247 (class 0 OID 83968)
-- Dependencies: 194
...
--
-- TOC entry 2253 (class 0 OID 94600)
-- Dependencies: 200
...
--
-- TOC entry 2110 (class 2606 OID 83952)
...
--
-- TOC entry 2116 (class 2606 OID 94595)
...
--
-- TOC entry 2115 (class 2606 OID 94578)
...
--
-- TOC entry 2120 (class 2606 OID 94627)
...
--
-- TOC entry 2119 (class 2606 OID 94622)
...
--
-- TOC entry 2114 (class 2606 OID 83993)
...
--
-- TOC entry 2113 (class 2606 OID 83988)
...
--
-- TOC entry 2112 (class 2606 OID 83978)
...
--
-- TOC entry 2111 (class 2606 OID 83973)
...
--
-- TOC entry 2118 (class 2606 OID 94611)
...
--
-- TOC entry 2117 (class 2606 OID 94606)
...
-- Completed on 2018-01-01 20:32:21
