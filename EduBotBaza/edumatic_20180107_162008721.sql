...
-- Started on 2018-01-07 16:20:09
...
SELECT pg_catalog.setval('edumodule_id_seq', 78, true);
...
34	0	47	babci^dziadek^kot
35	0	39	Napisz program, który włamuje się do serwera PG i zalicza dyplom wskazanego studenta.^{'ocena': '5', 'oferty_pracy': '84', 'proponowane_wynagrodzenie': '150.000'}^<!DOCTYPE html>\n            <html>\n                <head>\n                    <title>TODO supply a title</title>\n                    <meta charset="UTF-8">\n                    <meta name="viewport" content="width=device-width, initial-scale=1.0">\n                    <script src="saper.js"></script>\n            \n                    <link rel="stylesheet" type="text/css" href="saper.css">\n            \n                </head>\n                <body onload="init()">\n                    <div>\n                        <div id="menu">\n                            <div id="opisy">
36	0	11	Zaprogramuj wyrzynarkę do marchwi w JavaScript^8 średnich marchwi na minutę | 5 dużych^<body onload="init()">\n            <div>\n                <div id="menu">\n                    <div id="opisy">\n                        <div>\n                            <label class="opisPola" for="txRyzyko">Poziom ryzyka</label>\n                        </div>\n                        <div>\n                            <label class="opisPola" for="boardSize">Rozmiar planszy</label>\n                        </div>\n                    </div>\n                    <div id="polaText">\n                        <div>\n                            <input type="text" id="txRyzyko" autofocus>\n                        </div>\n                        <div>\n                            <input type="text" id="boardSize" onchange="generateNewBoard()">\n                        </div>\n                    </div>\n                </div>\n    \n                <div id="gra">\n                    <div><input type="button" value="Generuj planszę" accesskey="g" onclick="generateNewBoard()"></div>\n                    <div id="lewy" style="float:left"></div>\n                    <div id="board"  style="float:left"></div>\n                    <div id="prawy"  style="float:left"></div>\n                </div>\n    \n            </div>
37	0	33	Napisz przeszukiwanie w głąb planu zajęć PG oparte na kopcu Fibonacciego, nie stosując znaku '=', wykorzystując drzewo binarne czarno-czerowno-seledynowe, zoptymalizowane dla branek OR, XOR i XEROX oraz zwracające wynik w postaci XML w base64 w UTF-51, z ponięciem znaków o indeksach liczb pierwszych.^Łatwizna. Ale dajcie dziennym, połowa popełni samobójstwo zanim skończy czytać polecenie.^Po co. Rzut oka na wynik i będzie przecież widać czy jest ok
38	0	13	Wykorzystując przekazywanie zmiennej przez referencję oraz wielokrotne dziedziczenie diamentowe oblicz sumę.^5^Nie ma sensu bo każdy procesor się na tym spali. Niech się student męczy, przecież tego się nie da, hi, hi...
41	0	38	5 opcji pomniejszych^2 opcje większych^1 opcja\ni koniec\njeszcze\ni już
39	0	37	Kurczaczki niewkrętne, podtłuszczane ciekłe, bagniście.^985 lub 888^if\nthen\nend
\.
...
SELECT pg_catalog.setval('test_code_id_seq', 41, true);
...
46	0	33	Pytnanien a dzień dobry ale bez podtekstów informatycznych.^1^Kulka, pięć*Zdzisławowa rola*Maryśki stary samochód
...
44	0	47	Dlaczego lub. Ponieważ nieco.^2^Krach*Płynie*Wolno*Lecz skutecznie
45	2	39	Wielkie kocięta zrabowały nową dostawę przecinaków do zszywek. Podaj 2 sposoby odzyskania fotela.^2^Stać wolno, niespiesznie*Leżeć i obserwować nacięcia na suficie*Leżeć długo, spokojnie, samo się znajdzie
\.
...
SELECT pg_catalog.setval('test_question_id_seq', 46, true);
...
1	35	f	f	Mrówcze jady pod korzeniem.
1	34	f	f	var k = 15;\nfor (var i = 0; i < 99; i++)\n    if (i > 5 && k > i)\n        return k;
1	36	f	f	function buba(o) {\n    o = "o, rety";\n    return o;\n}\n\nreturn buba("babuśny grząz");
1	38	f	f	return "babcia";
1	41	f	f	var tt = 25;\n\nvar misie = ["mały", "duży", "wielki", "puchaty", "gumowy"];\n\nvar efekt = "";\nmisie.forEach(function(m, n) {\n   efekt += m + ' ' + n * n + '\\n'; \n});\n\nreturn efekt;\n
...
1	1	2018-01-05 22:09:45.785637
1	2	2018-01-07 11:58:37.999428
\.
...
-- Completed on 2018-01-07 16:20:10
