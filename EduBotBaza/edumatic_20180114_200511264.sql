...
-- Started on 2018-01-14 19:44:34
...
SELECT pg_catalog.setval('test_code_id_seq', 33, true);
...
1	4	t	t	<input id="pizzaNow" type="button" \n    value="Chcę pizzę teraz!">
1	5	t	t	var mojMaxPaczkow = 32;
1	6	t	t	var mojMaxPaczkow = 34;
1	10	f	f	var one, two, three, four;\none = "echami";\ntwo = "da z orz";\nthree = "kola";\nfour = "cze";\n\nvar zapas = four + three + two + one;
\.
...
-- Completed on 2018-01-14 19:44:36
